  ...
  return (
    <section className="py-10 md:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-card rounded-3xl p-6 md:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center">
            <a 
              ...
              className="glass-button px-6 md:px-8 py-3 rounded-xl font-medium text-gray-800 hover:scale-105 transition-all duration-300 inline-flex items-center gap-2"
            >
