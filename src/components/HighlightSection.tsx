    ...
    <section className="pb-10 md:pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {highlightProject && (
            <a href={highlightProject.link} target="_blank" rel="noopener noreferrer" className="block">
              <div className="glass-card rounded-2xl p-4 md:p-6 hover:scale-105 transition-all duration-300 group cursor-pointer">
                ...
                <p className="text-sm text-gray-600 line-clamp-2">{highlightProject.description}</p>
              </div>
            </a>
          )}
          
          {highlightArticle && (
            <a href={highlightArticle.link} target="_blank" rel="noopener noreferrer" className="block">
              <div className="glass-card rounded-2xl p-4 md:p-6 hover:scale-105 transition-all duration-300 group cursor-pointer">
                ...
                <p className="text-sm text-gray-600 line-clamp-2">{highlightArticle.description}</p>
              </div>
            </a>
          )}
          
          {highlightTalk && (
            <a href={highlightTalk.slideUrl} target="_blank" rel="noopener noreferrer" className="block">
              <div className="glass-card rounded-2xl p-4 md:p-6 hover:scale-105 transition-all duration-300 group cursor-pointer">
                ...
                <p className="text-xs text-gray-600">{highlightTalk.date}</p>
              </div>
            </a>
          )}
        </div>
